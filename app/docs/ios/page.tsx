...
LiveHive.register(activity)`}</code>
      ...
      <p>
        Add the local package from <code>sdks/ios</code> in this repository, or
        point Swift Package Manager at that directory. Production posts to{' '}
        <code>https://api.livehive.dev/v1/activities/register</code>. Override{' '}
        <code>baseURL</code> for development.
      </p>
      <ul>
