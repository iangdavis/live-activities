...
- [ ] Add package `https://github.com/iangdavis/livehive-ios` from `0.1.0` to the **app** target. Do not name the app module `livehive` / `LiveHive` — `cannot load module 'livehive' as 'LiveHive'`. Set app **Product Module Name** to `LiveHiveApp` (bundle ID can stay `com.iandavis.livehive`).
