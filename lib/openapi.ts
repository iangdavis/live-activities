...
export const openApiDocument = {
  ...
  info: {
    ...
    description:
      'iOS SDK starts a Live Activity and registers the push token. First update can come from the dashboard. Backends call update and end with a secret key. There is no server SDK. Canonical base: https://www.livehive.dev/v1. See https://livehive.dev/llms.txt',
  },
